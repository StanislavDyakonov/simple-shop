<template>
    <div class="item-table-wrap">
        <a class="item-table" :href="product.data.target_url" @click.prevent="onClick">
            <div class="item-table-photo" :style="getPhotoStyle"></div>
            ...
            <div class="item-table-info">
                ...
                <div class="item-table-discount" v-if="product.data.price !== product.data.oldPrice">
                    {{nf(product.data.oldPrice)}} ₽
                </div>
                <div class="item-table-btn" v-html="basket_ico" @click.prevent.stop="addToBasket"></div>
            </div>
        </a>
    </div>
</template>
